...
SMPP_MAXSESSIONS=8
SMPP_THROUGHPUT=5
$JAVA_HOME/bin/java -cp $CLASS_PATH com.ibm.smpp.client.utils.SMSClient $SMPP_HOST $SMPP_PORT $SMPP_USER $SMPP_PWD $SMPP_HOST2 $SMPP_PORT2 $SMPP_USER2 $SMPP_PWD2 $SMPP_SENDER $SMPP_MAXSESSIONS $THROUGHPUT "$SMPP_RECIPIENTS" "$SMPP_TEXT"
